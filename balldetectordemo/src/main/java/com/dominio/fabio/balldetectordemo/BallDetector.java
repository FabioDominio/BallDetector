        ...
        circles = new Mat();
         ...
         for (int i = 0; i < circles.cols(); i++){
            ...
            if (circT[2] > max_radius){
                circ[0] = circT[0]; circ[1] = circT[1]; circ[2] = circT[2];
         ...
         if (circles.cols() > 0){
            ...
            mask = Mat.zeros(square_size, square_size, CvType.CV_8U);
             ...
             calibration_frame = Mat.zeros(height, width, CvType.CV_8U);
                ...
                switch (color)
                {
                    case 1: circle_color = red; break;
                    case 2: circle_color = green; break;
                    case 3: circle_color = blue; break;
                    case 4: circle_color = yellow; break;
                    default:
                        circle_color = white; break;
                }
